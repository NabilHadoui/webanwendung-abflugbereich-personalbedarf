...
class JsEvalNode extends Node {
    ...
    evaluateJavaScript(expression, context) {
        ...
        try {
            ...
            throw {
                message: `JavaScript evaluation error: ${/** @type {Error} */ (e).message} from \`${expression}\``,
                filename: this.fileInfo().filename,
                index: this.getIndex()
            };
        }
        ...
        try {
            ...
            throw {
                message: `JavaScript evaluation error: '${/** @type {Error} */ (e).name}: ${/** @type {Error} */ (e).message.replace(/["]/g, '\'')}'`,
                filename: this.fileInfo().filename,
                index: this.getIndex()
            };
        }
